<template>
    <div class="phone-field field-box" :class="isError">
        ...
        <BasicButton size="medium" class="btn-cert">
            인증번호
        </BasicButton>
        ...
        <div class="flex">
            ...
            <button class="search-button" :disabled="disabled" type="button">
...
<style lang="scss" scoped src="./PhoneCertForm.scss"></style>
