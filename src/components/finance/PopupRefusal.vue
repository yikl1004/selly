<template>
    <div class="popup-refusal-wrap">
        <p class="txt">
            장기카드대출을 이용할 의사가 없는 회원님은 보이스피싱(전화금융사기) 피해방지를 위해 장기카드대출 이용거절을 신청할 수 있습니다.
        </p>
...
export default class PopupRefusal extends Vue {
    ...
    private infoRefusal = [
        ...
        {
            text: '장기카드대출 이용거절 신청은 당일 09:00~22:00 동안 가능합니다.',
        },
    ]

    private infoList = [
        {
            text: '비밀번호 및 CVC/4DBC 3회 이상 입력 오류시 서비스 제한을 받을 수 있습니다.',
        },
    ]
