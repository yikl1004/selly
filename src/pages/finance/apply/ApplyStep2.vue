<template>
    <Page floating :footer="false">
        ...
        <PageBody class="floating">
                    ...
                    >
                        <template slot-scope="{ schema }">
                            ...
                            <CheckBox
                                ...
                                :checked="false"
                                :index="null"
                                text="내용을 충분히 이해하였으며, 본 상품에 동의합니다."
                            />
            ...
            <!--상환방법 안내 팝업 -->
            <FullPopup
                :show.sync="popRepayment"
                title="상환방법 안내"
                :button-text="{ confirm: '확인' }"
                type="popup"
                @confirm="onRepaymentConfirm"
            >
                <PopupRepaymentInfo />
            </FullPopup>
            <!--//popup-->
...
export default class LoanApplication extends Vue {
    ...
    // s: popup_예상대금상환금
    private popPrediction = false
    openPopupPrediction() {
        this.popPrediction = true
    }
    onPredictionConfirm() {
        this.popPrediction = false
    }
    // e: popup

    // s: popup_상환방법안내
    private popRepayment = false
    openPopupRepayment() {
        this.popRepayment = true
    }
    onRepaymentConfirm() {
        this.popRepayment = false
    }
    // e: popup
...
<style scoped lang="scss" src="./ApplyStep2.scss" />
