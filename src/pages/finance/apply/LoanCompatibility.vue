...
export default class LoanCompatibility extends Vue {
    ...
    onManualConfirm() {
        this.popManualShow = false
    }
    // e: popup
    private infoList = [
        {
            text:
                '금융소비보호법에 따라 필수사항을 확인하셔야 다음 단계 진행이 가능합니다.',
        },
    ]
...
<style scoped lang="scss" src="./LoanCompatibility.scss" />
