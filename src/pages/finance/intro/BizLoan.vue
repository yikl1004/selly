<template>
    ...
    <Page floating>
        <Header type="sub" title="LOCA MONEY Biz론" />
        <PageBody class="floating">
            <div class="content finance-main-wrap">
                <Title
                    title="많이 번 날 많이 상환하고,<br/>적게 번 날 적게 상환하며<br/>이자 부담을 줄이는 스마트한 금융"
                />
                ...
                <div class="availability-box">
                    ...
                    <BulletList
                        :list="[
                            {
                                text:
                                    '개인의 소득과 신용도에 따라 대출금액이 수시로 변경될 수 있습니다.',
                            },
                        ]"
                    />

                    <!-- 이용불가_대출한도 부족 -->
                    <div class="unavailability-box">
                        <p>
                            죄송합니다.<br />회원님은 장기카드 대출 가능한도가
                            없습니다.
                        </p>
                    </div>
                ...
                <Title title="가맹점대금 상환(일)" type="h3">
                    <p>매출이 있는 날에 설정한 상환율만큼 상환</p>
                </Title>

                <div class="img-box">
                    <img
                        src="/assets/finance/img_visual_biz01.png"
                        alt="가맹점대금 상환(일) 1일차 매출 100만원 상환 10만원. 2일차 매출 20만원 상환 2만원. 3일차 매출 50만원 상환 5만원."
                    />
                </div>

                <div class="img-box line-type">
                    <div class="text-info">
                        <strong>일상환 예시)</strong>
                        <p>
                            상환금 5천만원 / 연 이자율 4.9%<br />대금상환율 13%
                            / 일매출 100만원
                        </p>
                    </div>
                    <img
                        src="/assets/finance/img_visual_biz02.png"
                        alt="가맹점대금 상환(일) 그래프"
                    />
                    <div class="info-box">
                        <strong class="total">총 납부이자 1,522,681원</strong>
                        <div class="benefit">
                            <span>청구상환(월) 대비</span>
                            <strong>927,319원 이자 감면효과</strong>
                        </div>
                    </div>
                </div>

                <Title title="청구서 상환(월)" type="h3">
                    <p>상환 기간 중 매월 동일한 원리금 및 이자납부</p>
                </Title>

                <div class="img-box line-type">
                    <div class="text-info">
                        <strong>일상환 예시)</strong>
                        <p>상환금 5천만원 / 연 이자율 4.9%</p>
                    </div>
                    <img
                        src="/assets/finance/img_visual_biz03.png"
                        alt="청구서 상환(월) 그래프"
                    />
                    <div class="info-box">
                        <strong class="total">총 납부이자 2,450,000원</strong>
                    </div>
                </div>
...
export default class BizLoan extends Vue {
    private infoList = [
        {
            text:
