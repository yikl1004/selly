    ...
    <Page floating>
        ...
        <PageBody class="floating">
            <div class="content finance-main-wrap">
                <div class="top-visual credit">
                    <div class="visual-inner">
                        <Title title="즉시 대출">
                            <p>365일 24시간 편리하게 이용해 보세요.</p>
                        </Title>
                        <div class="loan-info">
...
export default class CreditLoan extends Vue {
    private infoList = [
        {
            text:
    ...
    private accordionList: AccordionListItem[] = [
        {
            title: '상품안내',
            desc:
                '  <ul class="bul-list"> <li>중도상환수수료/취급수수료 : 없음</li><li>대출기간 : 3~36개월</li><li>상환방법 : 원리금균등상환</li><li>신청방법 : 모바일, PC</li></ul>',
        },
        {
            title: '대출절차',
            desc:
                ' <strong class="list-tit">STEP 1 본인인증</strong> <p>공동인증서 또는 휴대폰을 통한 인증을 진행합니다.</p><strong class="list-tit">STEP 2 한도조회</strong> <p>본인정보로 신용평점에 따른 대출가능금액 및 이자율을 확인합니다.</p><strong class="list-tit">STEP 3 대출신청</strong> <p>대출 신청에 필요한 정보를 입력합니다.</p><strong class="list-tit">STEP 4 대출금액지급</strong> <p>본인확인을 위한 상담원 통화 후 빠른 대출 심사를 거쳐 대출금이 지급됩니다.(직장인대출의 경우 소득증빙 과정이 추가됩니다.)</p>',
        },
        {
            title: '대출계약철회권',
            desc:
